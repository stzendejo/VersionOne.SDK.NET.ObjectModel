...
./$V1_SETUP -Quiet:2 -SigningKey:1BBD93C864A6001737BAA148DCDDB67E927982FA6A59E7DF53CDBDF0DD3CE29A -DbServer:$DB_SERVER -LogFile:$WORKSPACE\\TestSetup\\setup.log -DBName:$DB_NAME $INSTANCE_NAME
