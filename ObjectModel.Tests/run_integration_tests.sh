...
cd $WORKSPACE
../$NUNIT_CONSOLE_RUNNER //framework:net-4.0 //labels //stoponerror ${WORKSPACE}\\bin\\Release\\VersionOne.SDK.ObjectModel.Tests.dll //xml=run_integration_tests_results.xml
